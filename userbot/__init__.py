...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/fandi999/FANDI-UBOT")
UPSTREAM_REPO_BRANCH = os.environ.get(
    "UPSTREAM_REPO_BRANCH", "FANDI-UBOT")
...
# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "⭐FANDI-𝗨𝗕𝗢𝗧⭐"
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "FANDI-UBOT")
...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/suratanhatii"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/kemeemm"


# Last.fm Module
BIO_PREFIX = os.environ.get("BIO_PREFIX", None)
DEFAULT_BIO = os.environ.get("DEFAULT_BIO") or "⭐FANDI-𝗨𝗕𝗢𝗧⭐"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║FANDI-UBOT DAH AKTIF YA NGENTOT!!🔥🔥║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
